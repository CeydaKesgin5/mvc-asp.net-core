        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "/images/2.jpg", 16000m, "Mouse", false, "" },
                    { 3, 2, "/images/3.jpg", 15000m, "Keyboard", false, "" },
                    { 4, 2, "/images/4.jpg", 10000m, "Monitor", false, "" },
                    { 5, 2, "/images/5.jpg", 5000m, "Deck", false, "" },
                    { 6, 1, "/images/6.jpg", 25m, "History", false, "" },
                    { 7, 1, "/images/7.jpg", 50m, "Hamlet", false, "" },
                    { 8, 1, "/images/8.jpg", 5550m, "xp-pen", true, "" },
                    { 9, 2, "/images/9.jpg", 5460m, "galaxy fe", true, "" },
                    { 10, 1, "/images/10.jpg", 520m, "hp mouse", true, "" }
                });
